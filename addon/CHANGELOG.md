...
## [2026.07.18-h7175-rollback3] - 2026-07-18

### Fixed

- Stop querying the unsupported DIY-scene endpoint for H7175 kettles. Govee
  returns HTTP 400 for that request, which previously stopped MQTT discovery
  for every device.

## [2026.07.18-h7175-rollback2] - 2026-07-18

### Fixed

- Publish the retained H7175 kettle mapping again so Home Assistant can update
  from the add-on version that made the kettle unavailable.

## [2026.07.18-h7175-diy1] - 2026-07-18

### Changed

- Query the Govee DIY-scene endpoint for H7175 kettles even when Govee omits
  the dynamic-scene capability flag, allowing saved DIY actions to be
  discovered when the API returns them.

## [2026.07.18-h7175] - 2026-07-18

### Added

- Add H7175 Gooseneck Kettle support, including temperature and preset modes.
